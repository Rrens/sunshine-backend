                            ...
                            <div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2 mb-4">
                                <div class="card mb-4">
                                    @foreach ($data_single as $data)
                                        <form action="{{ route('update.barista', $data->id) }}" method="post"
                                            enctype="multipart/form-data">
                                            <h5 class="card-header">BARISTA EDIT</h5>
                                            <div class="card-body">
                                                @csrf
                                                <div class="mb-3 row">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input class="form-control" type="text" id="posisi"
                                                            name="posisi" value="{{ $data->posisi }}" />
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
