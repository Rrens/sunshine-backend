                        ...
                        <div class="row">
                            <div class="col-12 col-lg-12 order-2 order-md-3 order-lg-2 mb-4">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        @foreach ($data_single as $data)
                                            <form action="{{ route('update.menu', $data->id) }}" method="POST"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input class="form-control" type="number" id="harga"
                                                            name="harga" value="{{ $data->harga }}" />
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    <label for="jenis" class="col-md-2 col-form-label">Jenis
                                                        Produk</label>
                                                    <div class="col-md-10">
                                                        <select class="form-select" id="jenis"
                                                            aria-label="Default select example" name="jenis">
                                                            <option value="Starters"
                                                                {{ $data->jenis == 'Starters' ? 'selected' : '' }}>Starters
                                                            </option>
                                                            <option value="Salads"
                                                                {{ $data->jenis == 'Salads' ? 'selected' : '' }}>Salads
                                                            </option>
                                                            <option value="Specially"
                                                                {{ $data->jenis == 'Specially' ? 'selected' : '' }}>
                                                                Specially</option>
                                                        </select>
                                                    </div>
                                                </div>
