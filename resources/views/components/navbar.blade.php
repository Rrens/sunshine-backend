<!-- ======= Top Bar ======= -->
      ...
      >
        <div class="contact-info d-flex align-items-center">
          <i class="bi bi-phone d-flex align-items-center"
            ><a href="wa.me/6281511346634?text=hallo%20min%20sunshine"
              ><span>+62 815-1134-6634</span></a
            ></i
          >
          <i class="bi bi-clock d-flex align-items-center ms-4"
            ><span> Mon-Sat: 11AM - 10PM</span></i
          >
        </div>
    ...
    <header id="header" class="fixed-top d-flex align-items-cente">
      ...
      >
        ...
        <!-- <a href="index.html" class="logo me-auto me-lg-0"><img src="index/img/logo.png" alt="" class="img-fluid"></a>-->
